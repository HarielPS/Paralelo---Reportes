...

{
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=4 cm]{Figures/Theme/Logotypes/IPN.png} \hfill
        \includegraphics[width=4 cm]{Figures/Theme/Logotypes/ESCOM.png}
    \end{figure}
    
            
    % Title Escuela.
    \begin{center} % Asegura que todo el bloque esté centrado correctamente
        \bfseries\fontsize{16}{20}\selectfont \MakeUppercase{Instituto Politécnico Nacional}\\
        \rule{10cm}{0.5pt} % Línea separadora
        \\
        \bfseries\fontsize{14}{18}\selectfont \MakeUppercase{Escuela Superior de Cómputo}
    \end{center}
}
    ...
    \makebox[\textwidth][l]{%
        \parbox{\dimexpr\textwidth-4cm\relax}{
            \setstretch{1.03}
            \raggedright\bfseries\fontsize{18}{21}\selectfont\GetTitle
        }
    }
